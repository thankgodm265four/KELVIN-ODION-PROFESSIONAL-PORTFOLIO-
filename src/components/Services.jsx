    ...
    const services = [
        {
            ...
            description: "Strategic planning to position your brand for maximum market impact and audience connection."
        },
        {
            icon: (
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            description: "Building engaged communities and growing your social presence with strategic content and engagement."
        },
        {
            icon: (
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            description: "Strategic content calendars and execution that keeps your brand consistently visible and valuable."
        },
        {
            icon: (
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            description: "Words that sell. Persuasive copy crafted to turn readers into customers and clicks into conversions."
        },
        {
            icon: (
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            description: "End-to-end campaign planning and execution designed to achieve specific business objectives."
        },
        {
            icon: (
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            title: "Digital Product & Marketing Asset Creation",
            description: "Creating digital products and marketing materials that communicate your brand value effectively."
        }
    ];
