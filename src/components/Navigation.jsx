      ...
      <div className="container-custom">
        <div className="flex items-center justify-between">
            ...
            <ul className="flex items-center gap-6">
              {navLinks.map((link) => (
                <li key={link.href}>
                  <a
                    href={link.href}
                    className="relative text-gray-600 hover:text-primary-500 font-medium transition-colors duration-300 py-2 group"
                  >
                    {link.label}
          ...
          <button
            ...
            className="lg:hidden p-2 text-navy-500 hover:text-primary-500 transition-colors"
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 space-y-4 border border-gray-100">
            {navLinks.map((link) => (
              <a
                ...
                className="block text-gray-600 hover:text-primary-500 font-medium transition-colors py-2 border-b border-gray-100 last:border-0"
              >
                {link.label}
              </a>
            ))}
